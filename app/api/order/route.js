...
//     // console.log(body);
//     if (body.payment_info.method === "cash-on-delivery") {
...
//           },
//           body: JSON.stringify({
//             amount: 2000 + body.shipping_details.shipping_charge,
//             merchantInvoiceNumber: body.order_number,
//           }),
//         }
//       );
...
//             merchantInvoiceNumber: body.order_number,
//             payerReference: body.customer.phone_number,
//           }),
//         }
//       );
//       if (!res.ok) {
...
//     const mailOptions = {
//       to: body?.email,
//       subject: `Order Confirmation for #${order[0].order_number} - Thank you for your purchase!`,
//       html: `
//       <!DOCTYPE html>
//       <html>
//         <head>
...
//           <div class="container">
//             <div class="header">
//               <img src="https://res.cloudinary.com/djrwougmx/image/upload/v1733326502/kabbo_shop_logo_1_kjycg8.png" alt="Store Logo" class="logo">
...
//                   order[0]?.shipping_details.address
//                 }</p>
//               </div>
...
//                   order[0]?.shipping_details.shipping_charge
//                 }</p>
...
//                 <p>Email: kabbomobileshop31@gmail.com</p>
//                 <p>Phone: 01704282029</p>
//                 <p>website: <a href="https://www.kabbomobileshop.com" target="_blank">www.kabbomobileshop.com</a></p>
//               </div>
//             </div>
...
//                 <a href="https://www.facebook.com/kabbomobileshop" style="margin: 0 10px;">Facebook</a>
//                 <a href="https://www.instagram.com/kabbomobile/" style="margin: 0 10px;">Instagram</a>
//                 <a href="https://www.youtube.com/@kabbomobileshopofficial" style="margin: 0 10px;">Youtube</a>
//               </div>
